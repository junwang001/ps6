...
public class PersonOverviewController {
    ...
    private void handleDeletePerson() {
        ...
        if (selectedIndex >= 0) {
        	...
        	PersonDAL.deletePerson(mainApp.getPersonData().get(selectedIndex).getPersonID());
    ...
    private void handleNewPerson() {
        ...
        tempPerson.setPersonID(UUID.randomUUID());
        boolean okClicked = mainApp.showPersonEditDialog(tempPerson);
        if (okClicked) {
        	PersonDomainModel personDomainModel = new PersonDomainModel();
        	BeanUtils.copyProperties(tempPerson, personDomainModel);
    ...
    private void handleEditPerson() {
        ...
        if (selectedPerson != null) {
            ...
            if (okClicked) {
            	PersonDomainModel personDomainModel = new PersonDomainModel();
            	BeanUtils.copyProperties(selectedPerson, personDomainModel);
            	//PS6 - Calling the addPerson method
